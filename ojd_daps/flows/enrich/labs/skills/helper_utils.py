...
def get_skill_embeddings(bert_model='paraphrase-distilroberta-base-v1'):
    # Skill entity ids
    skill_ids = np.load(DATA_PATH / f'processed/embeddings/skills_labels_all_entity_ids.npy')
    # Embeddings
    embed = np.load(DATA_PATH / f'processed/embeddings/skills_labels_all_{bert_model}.npy')
